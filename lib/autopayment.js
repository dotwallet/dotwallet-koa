...
exports.autopayment = function (APP_ID, SECRET) {
    return function (ctx, orderData, redirect, log) { return __awaiter(void 0, void 0, void 0, function () {
        var returnData, orderWithSecret, orderResponse, orderResponseData, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    orderWithSecret = __assign(__assign({}, orderData), { secret: SECRET });
                    if (log)
                        console.log('==============posting order==============\n', orderWithSecret);
                    return [4 /*yield*/, axios_1.default.post('https://www.ddpurse.com/openapi/pay_small_money', orderWithSecret)];
                case 1:
